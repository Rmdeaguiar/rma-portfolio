    ...
    <div className="container-about">
      ...
      <div className='about-content'>
        <div className='content-text'>
          ...
          <p>Desenvolvedor desde 2021, focado em criar soluções que proporcionem a melhor experiência para o usuário. Tenho facilidade em me adaptar a novas tecnologias e de transformar desafios em oportunidades de aprendizado, sempre aprendendo e evoluindo para entregar soluções que gerem alto valor e impacto direto para os clientes.</p>
        </div>
